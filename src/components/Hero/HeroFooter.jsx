...
const HeroFooter = () => {
	return (
		<>
			...
			<a
				href="/#upcoming"
				className="flex mt-6 pl-2 pr-4 py-2 border-2 border-highlight rounded-full font-bold items-center hover:bg-soft-gray hover:text-highlight transition-all"
			>
